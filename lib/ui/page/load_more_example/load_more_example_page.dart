...
@RoutePage(name: 'LoadMoreExampleRoute')
class LoadMoreExamplePage extends BasePage<LoadMoreExampleState,
    AutoDisposeStateNotifierProvider<LoadMoreExampleViewModel, CommonState<LoadMoreExampleState>>> {
  const LoadMoreExamplePage({this.cacheManager, super.key});

  @override
  ScreenViewEvent get screenViewEvent =>
      ScreenViewEvent(screenName: ScreenName.loadMoreExamplePage);

  @override
  AutoDisposeStateNotifierProvider<LoadMoreExampleViewModel, CommonState<LoadMoreExampleState>>
      get provider => loadMoreExampleViewModelProvider;
